...
<head>
	...
	<link href="media/css/uniform.default.css" rel="stylesheet" type="text/css"/>		<link href="customer/css/MC-Cottage.css" rel="stylesheet" type="text/css"/>
...
<body class="login">
	...
	<div class="content">
		...
		<form class="form-vertical login-form" action="index.html">
			<h3 class="form-title">欢迎登陆MC-Cottage</h3>
			...
			<div class="form-actions">
				...
				<div type="submit" id="login-button" class="btn green pull-right">
